/**
 * This class tests Issue 887 - Project Reports Detail - Reports - Include Full Project Name in Burn Down Reports
...
public class ProjectReportsDetailReportsIncludeFullProjectName extends WebBaseTest {
    ...
    @Test
    public void testProjectReportsDetailReportsIncludeFullProjectName() {
    	...
    	// Step 8 Select the 'detail' radio button
    	reporting.clickDetail();
